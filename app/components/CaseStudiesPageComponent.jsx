...
export default function CaseStudiesPageComponent() {
  ...
  // Filter categories
  const categories = ['All', 'E-commerce', 'Technology', 'Health & Wellness', 'Finance', 'Beauty', 'Travel'];
  ...
  const allCaseStudies = [
    {
      ...
      summary: 'FashionBrand partnered with 25 micro-influencers to promote their summer collection, resulting in a 73% increase in sales compared to the previous quarter.',
    ...
    },
    {
      ...
      summary: 'TechGadget leveraged our platform to find tech influencers for their new product launch, generating over 12,500 pre-orders and significant media attention.',
    ...
    },
    {
      ...
      summary: 'WellnessApp worked with health and fitness influencers to promote their meditation app, achieving 45,000 downloads with a retention rate well above industry average.',
    ...
    },
    {
      ...
      summary: 'FinanceApp collaborated with financial education influencers to explain complex investment concepts, driving a significant increase in new account signups.',
      metrics: { growth: '128%', retention: '72%', conversion: '8.3%' },
      image: "/globe.svg",
      logo: '/casestudies/finance-logo.svg',
      color: 'from-blue-500 to-cyan-500'
    },
    {
      id: 5,
      category: 'Beauty',
      title: 'How BeautyCo launched a new product line with influencer partnerships',
      ...
      image: "/vercel.svg",
      logo: '/casestudies/beauty-logo.svg',
    ...
    },
    {
      ...
      summary: 'TravelAgency partnered with travel influencers to showcase exotic destinations, resulting in a significant increase in bookings and engagement.',
      metrics: { bookings: '+65%', engagement: '320K', reach: '4.7M' },
      image: "/vercel.svg",
      logo: '/casestudies/travel-logo.svg',
  ...
  return (
    <>
      ...
      {/* Hero section */}
      <section className="relative py-24 bg-gradient-to-r from-blue-900 to-indigo-800 text-white overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <AnimatedSection animation="fade" className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Explore real success stories from brands that have leveraged our platform
              to create impactful influencer marketing campaigns.
            </p>
          </AnimatedSection>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-6">
            {filteredCaseStudies.length > 0 ? (
              filteredCaseStudies.map((caseStudy, index) => (
                ...
                >
                  <Link href={`/casestudies/${caseStudy.id}`} className="block h-full">
                    <div className="relative h-48 overflow-hidden">
                      <div className={`absolute inset-0 bg-gradient-to-br ${caseStudy.color} opacity-90 z-10`}></div>
                      <Image
                        src={caseStudy.image}
                        alt={caseStudy.title}
                        fill
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 mb-4 text-sm line-clamp-3">{caseStudy.summary}</p>

                      <div className="flex justify-between items-center">
                        <div className={`text-sm font-semibold bg-gradient-to-r ${caseStudy.color} bg-clip-text text-transparent`}>
                          View Case Study
                        </div>
              ...
              <div className="col-span-full text-center py-12">
                <h3 className="text-xl font-medium text-gray-500">No case studies found for this category</h3>
                <button
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection animation="fade" className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8">
              ...
              meaningful connections with influencers and drive business results.
            </p>
            <Link
              href="/signup"
