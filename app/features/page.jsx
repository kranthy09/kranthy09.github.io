  ...
  const commonFeatures = [
    {
      ...
      description:
        "Our proprietary algorithm analyzes audience demographics, content quality, engagement metrics, and brand values to create perfect partnerships.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Create, negotiate, and sign contracts digitally with standardized templates, automated milestone tracking, and revision history.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10 text-white"
    ...
    },
    {
      ...
      description:
        "Transparent invoicing, automated payments, secure escrow services, and tax documentation simplify financial transactions.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10 text-white"
  ...
  const brandFeatures = [
    {
      ...
      description:
        "Find the perfect influencers with advanced filters for audience demographics, engagement rates, content categories, and performance metrics.",
      image: "/file.svg",
      stats: [
    ...
    },
    {
      ...
      description:
        "Plan, execute, and monitor multiple campaigns simultaneously with content calendars, approval workflows, and real-time status tracking.",
      image: "/file.svg",
      stats: [
    ...
    },
    {
      ...
      description:
        "Measure ROI with comprehensive performance tracking across impressions, engagement, conversions, and audience growth metrics.",
      image: "/file.svg",
      stats: [
    ...
    },
    {
      ...
      description:
        "Ensure content aligns with your brand values through content verification, automated brand guideline checks, and sentiment analysis.",
      image: "/file.svg",
      stats: [
  ...
  const influencerFeatures = [
    {
      ...
      description:
        "Create a professional profile that highlights your content, audience demographics, engagement metrics, and past collaborations.",
      image: "/file.svg",
      stats: [
    ...
    },
    {
      ...
      description:
        "Browse and apply to brand campaigns that match your content niche, audience, and partnership preferences.",
      image: "/file.svg",
      stats: [
    ...
    },
    {
      ...
      description:
        "Schedule posts, track content approvals, and manage deliverables across multiple platforms and campaigns.",
      image: "/file.svg",
      stats: [
    ...
    },
    {
      ...
      description:
        "Track audience growth, engagement trends, and campaign performance to optimize your content strategy.",
      image: "/file.svg",
      stats: [
        ...
        <div className="container relative z-10 mx-auto px-4 pt-20 pb-12">
          <AnimatedSection animation="fade" className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
              Our comprehensive suite of features empowers brands and
              influencers to create successful partnerships through technology
              and transparency.
            </p>
            <button
            ...
            <div className="relative h-64 md:h-96 rounded-xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <p className="text-blue-100 max-w-2xl">
                  Discover, manage, measure, and grow—all in one seamless
                  ecosystem.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection animation="fade" className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Our platform offers powerful features designed to streamline
              collaboration between brands and influencers, ensuring successful
              partnerships.
            </p>
          </AnimatedSection>
          ...
          <div className="space-y-16 md:space-y-24">
            {commonFeatures.map((feature, index) => (
              <AnimatedSection key={index} animation="fade">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className={index % 2 === 1 ? "md:order-2" : ""}>
                    <div className="relative">
                      <div
                        className={`absolute -top-6 -left-6 md:-top-10 md:-left-10 bg-gradient-to-r ${feature.color} p-4 md:p-6 rounded-2xl shadow-lg z-10`}
                      >
                        {feature.icon}
                      </div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            <AnimatedSection animation="fade" className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto">
                Our platform provides tailored features that address the
                specific needs of both brands and influencers.
              </p>
            </AnimatedSection>
            ...
            >
              <Link
                ...
                className={`inline-block px-8 py-4 rounded-lg text-white font-medium transform hover:-translate-y-1 transition-all duration-300 ${
                  activeTab === "brands"
              ...
              >
                Learn More About{" "}
                {activeTab === "brands" ? "Brand" : "Influencer"} Features
              </Link>
            </AnimatedSection>
          </div>
        </section>
            ...
            <table className="w-full min-w-[768px] border-collapse">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="p-4 border-b border-gray-200 text-center font-medium text-blue-600">
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join thousands of brands and influencers already using our
              platform to create successful partnerships.
            </p>
