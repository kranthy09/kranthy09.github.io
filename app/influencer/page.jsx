...
import AudienceDemographics from "@/app/components/dashboardOverview/influencer/AudienceDemographics";
import RichAnalyticsIcon from "@/app/components/icons/RichAnalyticsIcon";
  ...
  const influencerFeatures = [
    {
      ...
      description:
        "Showcase your content, audience demographics, and engagement rates with a professional profile that helps attract brand partnerships.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Our AI-powered algorithm connects you with brands that align with your content style, values, and audience demographics.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-indigo-600"
    ...
    },
    {
      ...
      description:
        "Track all your brand partnerships in one dashboard, with integrated content calendars, approval workflows, and deadline reminders.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-indigo-600"
    ...
    },
    {
      ...
      description:
        "Gain insights into your performance with comprehensive analytics on engagement, audience growth, and campaign effectiveness.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-indigo-600"
    ...
    },
    {
      ...
      description:
        "Protect your interests with standardized contracts that clearly outline deliverables, payment terms, and usage rights.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-indigo-600"
    ...
    },
    {
      ...
      description:
        "Get paid on time with our secure payment processing system that handles invoicing, tax documentation, and international transfers.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-indigo-600"
  ...
  const influencerBenefits = [
    {
      ...
      description:
        "Connect with leading brands in your niche and build long-term partnerships that help expand your influence and reach.",
      image: "/icons/analytics-icon.svg",
    },
    {
      title: "Monetize Your Content",
      description:
        "Turn your passion into profit with fair compensation for your creative work and audience engagement.",
      image: "/icons/monetize-content-icon.svg",
    },
    {
      title: "Save Time & Effort",
      description:
        "Focus on creating great content while we handle the paperwork, negotiations, and administrative tasks.",
      image: "/icons/save-time-icon.svg",
    },
  ];
  ...
  const influencerTiers = [
    {
      ...
      followers: "1K-10K",
      description:
        "Perfect for focused niche audiences with high engagement rates",
      benefits: [
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center pt-32 pb-20">
          ...
          <AnimatedSection animation="slide-up" className="max-w-3xl">
            ...
            <p className="text-xl text-indigo-100 mb-8">
              Connect with brands that align with your values, manage your
              partnerships efficiently, and grow your career as a content
              creator.
            </p>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600">
              We empower influencers to build sustainable careers through
              meaningful brand partnerships and powerful management tools.
            </p>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection animation="fade" className="text-center mb-16">
            ...
            <h2 className="text-3xl font-bold mt-2 mb-4">
              Tools Built for Creator Success
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Our platform provides influencers with everything needed to manage
              partnerships professionally, showcase their value, and maximize
              earnings.
            </p>
          </AnimatedSection>
            ...
            <div>
              ...
              <AnimatedSection animation="slide-left" options={{ delay: 200 }}>
                <p className="text-gray-700 mb-6">
                  Track all your brand partnerships, content deliverables, and
                  performance metrics in one intuitive dashboard designed
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <AnimatedSection animation="fade" className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Our platform is designed to help influencers build sustainable
              careers and meaningful brand relationships while maintaining
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 md:p-10">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                ...
                <div>
                  <svg
                    className="h-10 w-10 text-indigo-300 mb-4"
                    fill="currentColor"
                    viewBox="0 0 32 32"
                  >
                  ...
                  <p className="text-xl md:text-2xl mb-6 leading-relaxed">
                    What sets InfluenceAI apart is its ability to tailor
                    strategies to my unique brand. They understand my audience
                    and create campaigns that truly reflect my personality I
                    have complete trust in Influence AI. They're not just an
                    agency; they're true partners who genuinely care about my
                    success as an influencer.
                  </p>
                  <div>
                    <div className="font-semibold text-lg">Priyanka Jain</div>
                    <div className="text-indigo-200">
                      Actor/Lifestyle Influencer, 853K followers
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <AnimatedSection animation="fade" className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              We offer specialized features and commission rates based on your
              audience size and career stage. There are no monthly fees—we only
              earn when you do.
            </p>
          </AnimatedSection>
            ...
            {influencerTiers.map((tier, index) => (
              <AnimatedSection
                ...
                className={`rounded-xl overflow-hidden ${
                  tier.featured
                    ? "transform scale-105 shadow-xl border-2 border-indigo-500 relative"
                    : "shadow-lg"
                }`}
              >
                {tier.featured && (
                ...
                <div className={`p-1 bg-gradient-to-r ${tier.color}`}>
                  <div className="bg-white p-7 rounded-t-lg">
                    ...
                    <div className="mb-6 text-center text-indigo-600 font-bold">
                      {tier.commission}
                    </div>
          ...
          >
            <p className="text-gray-600 mb-6">
              Not sure which tier is right for you? Our team can help determine
              the best fit for your specific audience and goals.
            </p>
            <Link
              href="/contact"
