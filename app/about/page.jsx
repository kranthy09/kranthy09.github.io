  ...
  const coreValues = [
    {
      title: "Authenticity",
      description:
        "We believe in fostering genuine connections between brands and influencers that resonate with audiences.",
      icon: (
        <svg
    ...
    },
    {
      title: "Transparency",
      description:
        "Clear communication, honest metrics, and fair business practices are at the heart of everything we do.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-blue-600"
    ...
    },
    {
      title: "Innovation",
      description:
        "We continuously evolve our platform with cutting-edge technology to meet the changing needs of the industry.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-blue-600"
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              We're on a mission to transform influencer marketing through
              technology, transparency, and authentic connections.
            </p>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection animation="slide-left">
              ...
              <p className="text-gray-700 mb-4">
                Founded in 2020, our platform was created to bridge the gap
              ...
              <p className="text-gray-700">
                We envision a future where influencer marketing is accessible to
                businesses of all sizes, with clear metrics and genuine
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection animation="fade" className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              ...
              define how we interact with our community.
            </p>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl mb-8">
              Whether you're a brand looking to grow or an influencer ready to
              build your career, we'd love to have you as part of our story.
            </p>
