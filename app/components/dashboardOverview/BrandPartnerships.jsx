        ...
        <div className="space-y-4">
          <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-100">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[10px] bg-green-100 text-green-800 py-1 px-2 rounded">
                Active
              </span>
            </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[10px] bg-yellow-100 text-yellow-800 py-1 px-2 rounded">
                Negotiating
              </span>
            </div>
            <p className="text-[10px] text-gray-600 mt-1">
            ...
            <button className="mt-2 text-[10px] text-indigo-600 font-medium">
              Review proposal
            </button>
          </div>
        </div>
