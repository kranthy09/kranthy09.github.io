    ...
    const brandFeatures = [
        {
            ...
            description: "Find the perfect influencers for your brand through our AI-powered matching system that analyzes audience demographics, engagement metrics, and content quality.",
            icon: (
        ...
        },
        {
            ...
            description: "Plan, execute, and monitor multiple campaigns simultaneously through our intuitive dashboard. Set goals, track deliverables, and manage content approvals in one place.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        },
        {
            ...
            description: "Measure campaign success with comprehensive reporting tools that track impressions, engagement, conversions, and ROI. Gain actionable insights to optimize future campaigns.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
        ...
        },
        {
            ...
            description: "Streamline agreements with automated contract generation and secure payment processing. Manage terms, deliverables, and milestone-based payments all within the platform.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        },
        {
            ...
            description: "Gain deep insights into influencer audiences through demographic analysis, interest mapping, and engagement patterns to ensure your brand reaches the right consumers.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        },
        {
            ...
            description: "Review and approve influencer content before publication with our collaborative workflow tools featuring commenting, revision tracking, and approval automation.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    const brandBenefits = [
        {
            ...
            description: "Expand your reach and increase visibility through authentic partnerships with influencers who resonate with your target audience.",
            image: "/globe.svg"
        },
        {
            title: "Drive Conversions & Sales",
            description: "Generate measurable results with conversion-focused campaigns that turn influencer audiences into loyal customers.",
            image: "/vercel.svg"
        },
        {
            title: "Build Brand Trust & Credibility",
            description: "Leverage the trust influencers have established with their audiences to build credibility for your brand and products.",
            image: "/file.svg"
        }
    ];
                ...
                <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center pt-32 pb-20">
                    ...
                    <AnimatedSection animation="slide-up" className="max-w-3xl">
                        ...
                        <p className="text-xl text-blue-100 mb-8">
                            Connect with the perfect influencers for your brand, manage campaigns efficiently, and measure real results with our comprehensive platform.
                        </p>
                    </AnimatedSection>
                    ...
                    <AnimatedSection animation="fade" options={{ delay: 600 }} className="mt-16">
                        <div className="flex justify-center">
                            <div className="flex space-x-8 items-center">
                                ...
                                <Image src="./Nextjs-logo.svg" alt='logo3' height={50} width={50} />
                            </div>
                        </div>
                    </AnimatedSection>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <AnimatedSection animation="fade" className="max-w-4xl mx-auto text-center mb-12">
                        ...
                        <p className="text-gray-600">
                            Our platform connects brands with influencers who authentically align with their values and goals, driving measurable results across all channels.
                        </p>
                    </AnimatedSection>
            ...
            <section ref={featuresRef} className="py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    <AnimatedSection animation="fade" className="text-center mb-16">
                        ...
                        <h2 className="text-3xl font-bold mt-2 mb-4">Everything You Need for Successful Influencer Campaigns</h2>
                        <p className="text-gray-600 max-w-3xl mx-auto">
                            Our comprehensive platform provides brands with all the tools needed to discover perfect influencer matches, manage campaigns effectively, and measure real business impact.
                        </p>
                    </AnimatedSection>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <AnimatedSection animation="fade">
                                    <h2 className="text-3xl font-bold mb-6">Powerful Analytics Dashboard</h2>
                                </AnimatedSection>

                                <AnimatedSection animation="slide-right" options={{ delay: 200 }}>
                                    <p className="text-gray-700 mb-6">
                                        Our intuitive dashboard gives you a comprehensive view of all your influencer marketing campaigns. Track performance metrics, monitor content approvals, and measure ROI—all in one place.
                                    </p>
                                </AnimatedSection>

                                <AnimatedSection animation="slide-right" options={{ delay: 300 }}>
                                    <ul className="space-y-4 mb-8">
                                        ...
                                        <li className="flex items-start">
                                            ...
                                            <span>Content approval workflows and status tracking</span>
                                        </li>
                                    </ul>
                                </AnimatedSection>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    <AnimatedSection animation="fade" className="text-center mb-16">
                        ...
                        <h2 className="text-3xl font-bold mt-2 mb-4">Key Benefits for Brands</h2>
                        <p className="text-gray-600 max-w-3xl mx-auto">
                            Our platform is designed to help brands maximize the impact of their influencer marketing efforts through strategic partnerships and data-driven decision making.
                        </p>
                    </AnimatedSection>
            ...
            <section className="py-20 bg-gradient-to-r from-blue-800 to-indigo-900 text-white">
                <div className="container mx-auto px-4">
                    <AnimatedSection animation="fade" className="text-center mb-12">
                        ...
                        <h2 className="text-3xl font-bold mb-4">What Brands Say About Us</h2>
                    </AnimatedSection>
                            ...
                            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl md:text-2xl mb-6 leading-relaxed">
                                        This platform has transformed our influencer marketing strategy. We've seen a 45% increase in engagement and a significant boost in conversions. The analytics tools make it easy to demonstrate ROI to our leadership team.
                                    </p>
                                    <div>
                                        <div className="font-semibold text-lg">Sarah Johnson</div>
                                        <div className="text-blue-200">Marketing Director, TechBrand</div>
                                    </div>
                                </div>
                            </div>
                        </div>
